        ...
        <div className="bg-lightblue py-20 px-4">
          <div className="mx-auto max-w-6xl flex flex-col  md:flex-row">
            ...
            <dl className="w-full md:w-2/3">
              ...
              <dd className="mb-16">
                <p>
                  We don’t. Valohai isn’t a data science platform; its a
                  Machine Learning Management Platform that handles the whole ML
                  pipeline from feature extraction, to training of your model
                  and to deploying it into production in a reproducible manner.
                  Data science platforms offer hosted notebooks and AutoML
                  solutions.
                </p>
              </dd>
              <dt className="mb-4">
              ...
              <dd className="mb-16">
                <p>
                  Depends. Most of our customers use their own cloud and thus
                  pay for usage according to their own agreements. Valohai
                  doesnt charge anything on top of the per-user license fee. If
                  you dont have a cloud provider, you can use our AWS, GCP and
                  Azure accounts, and well only charge you for what you use.
                </p>
              </dd>
            </dl>
          </div>
